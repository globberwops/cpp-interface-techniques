...
TEST(CrtpTest, OptionalMap) {
  using gw::cpp_interface_techniques::crtp::LaneId;
  using gw::cpp_interface_techniques::crtp::RoadId;

  auto map = gw::cpp_interface_techniques::optional_map::Map{};
  auto map_adapter = gw::cpp_interface_techniques::crtp::optional_map::MapAdapter{map};
